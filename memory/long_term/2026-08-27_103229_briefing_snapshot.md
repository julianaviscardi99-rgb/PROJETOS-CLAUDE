...
- Ainda falta a usuária explicar a lógica do arquivo/aba **Flash** — não presumir nada, ela vai detalhar na próxima sessão.
...
---
## PRÓXIMA SESSÃO — continuar o escopo do Passo 7 (P&L)
1. **Usuária vai explicar a lógica do arquivo/aba Flash** do P&L (pendência explícita dela) — só depois disso fechar o desenho completo da automação.
2. Decidir formato: script standalone primeiro (como os outros passos) ou já pensar a integração no cockpit.
3. Quando implementar de verdade: aplicar o fix do link de PY (Agosto) + os 3 links mensais (Mensalização/Forecast/Flash) + os textos (Q4/AF4/D4/F5/G5/H5) — sempre testado em cópia isolada antes de tocar na rede (regra do processo, `DECISOES.md` 2026-08-14).
